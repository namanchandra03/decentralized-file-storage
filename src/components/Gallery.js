...
export default function Gallery() {
  ...
  function handleDownload() {
    ...
    async function handleDelete() {
      ...
      try {
        await database.favourites
        .where("id","==",data.img.id)
        .delete();
    ...
    function handleFav(){
        ...
        database.favourites.add(data.img)
    }
      ...
      {data.img ? (
        ...
        >
          <div className="tw-flex tw-justify-between tw-w-64 tw-absolute tw-mx-auto tw-top-10 ">
            <BsCloudDownload size={32} color={"white"} onClick={handleDownload} />
            <AiOutlineDelete size={32} color={"white"} onClick={handleDelete}/>
            <AiOutlineStar size={32} color={"white"} onClick={handleFav} />
          </div>
          <AiOutlineClose
            size={32}
            style={{
